...
# Provides internationalization(I18N) and localization(L10N) services 
# for your Python modules and applications. It supports both the GNU gettext 
# message catalog API and a higher level, class-based API that may be more 
# appropiate for Python files.
...
class BuildStepError(CerberoException):
	...
	# step reflects the current status 
