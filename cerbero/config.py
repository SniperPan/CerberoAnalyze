...
# Variants to enable or disable modules, maybe the main switcher is here @Sniper
...
class Config (object):
    ...
    def load(self, filename=None):
        ...
        # Next parse the main (default) configuration file
        ...
        # Conatain source, cache ...etc
        self._load_last_defaults()

        # Load the platform config, so the sequence is below:
        # default -> file configuratioin -> common defaults -> platform
    ...
    # Prepare the path for build : ./cerbero/cerbero/build/build-tools
	...
	# load configuration default or from default config file
