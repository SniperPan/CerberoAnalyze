...
# collectioins - High-performance container datatypes
...
# de-serializing a Python object struct.
import pickle

# time - Time access and conversions
# Provides various time-related functions. Although this module is always available,
# but not all functions are available on all platforms.
import time

# imp - Access the import internals
# Provides an interface to the mechanisms used to implement the import statement.
import imp
...
class CookBook (object):
    ...
    # @Sniper load_recipes_from_dir()? so comes from the dir files?
