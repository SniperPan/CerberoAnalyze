...
# Provides access like the list of installation paths and the configuration variables 
...
# Element designed to store hierarchical data structures in memory.
# The type can be described as a cross between a list and a dictionary.
    import xml.etree.cElementTree as etree
except ImportError:
    from lxml import etree
	
# gettext - Multilingual internationlization services
# Provides internationlization(I18N) and localization(L10N) services 
# Python moudles and applications.
import gettext
